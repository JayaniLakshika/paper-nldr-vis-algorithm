...
- **p. 14**: "which occurs due the intentional design that one cluster is slightly 3-D and
perfectly captured by a 2-D layout" – not valid English, and also plausibly inverts the
intended meaning. I assume this should be something like: "which occurs due to the
intentional design that this cluster is slightly 3-D and thus not able to be perfectly
