...
We thank the anonymous associate editor and reviewers for their careful reviews. What follows is our point-by-point response to reviewer comments. *Our responses are in italic text*. 
...
*We have revised Section 3.5 (now 7) to better explain the approach. The primary comparison is with one existing approach available in UMAP. Our approach is very simple, but not entirely unlike the UMAP procedure. We show how our approach would provide reasonable predicted positions for each of the layouts shown in the simulated example. This demonstrates clearly why our approach is actually useful and could be used for any NLDR techniques where the full data is available. We do acknowledge your point that this has plenty of room for improvement, but argue that it should be part of potential future work.*
