...
*We appreciate this point. Changes explained in the review comments for the second review below.*
...
<!--
*We have revised Section 3.5 in several ways:*
...
*Point taken. This section has been revised to be more explicit.*
...
*This is not a fair statement, but we take it in stride, and have carefully proof-read the revised paper. TODO*
...
*We have submitted a diff file between versions that will help to read the revision.TODO*
...
*Paper has been modified to better reflect the use of HBE relative to other measures, for the simulated example and the applications. TODO*

*We have revised the text to better reflect the use of HBE in choosing layouts. It should be considered a tool to help select a layout from a range of choices, not just as a diagnostic tool. TODO*
...
*The paper does describe an approach to helping choose the a layout from a selection of layouts. The text has been revised to make this point clearer. TODO*
...
*We have revised the paper to better explain the tuning. TODO*
...
*We have revised Section 3.5 to better explain the approach, in the context of the one existing approach available in UMAP. This demonstrates clearly why our approach is actually useful and could be used for other NLDR techniques. However, it is a big area of work and well-suited to future endeavours. TODO*
...
*Notation removed, yes, not necessary. TODO?*
...
- HBE vs average bin count plots moved into Appendix
- OTher things moved....
