...
RNX_curves <- read_rds(here::here("data/two_nonlinear/RNX_curves.rds"))
...
```{r}
shepard_all <- read_rds(here::here("data/two_nonlinear/shepard_all.rds"))
...
```{r}
eval_results <- read_rds(here::here("data/two_nonlinear/nldr_eval_metrics.rds"))
