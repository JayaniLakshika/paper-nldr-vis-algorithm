...
first \(9\) principal components to generate the UMAP. The objective is
...
scDEED to be more accurate. The layout a and b contain \(46\) and \(15\)
...
\caption{\label{fig-pbmc-mse-umap}Assessing which of the two UMAP
layouts with different hyper-parameter settings (n\_neighbors: \(30\),
...
\includegraphics[width=0.3\linewidth,height=\textheight,keepaspectratio]{appendix_files/figure-pdf/fig-model-pbmc-author-proj-scdeed-1.pdf}
