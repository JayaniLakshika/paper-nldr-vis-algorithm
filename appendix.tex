...
metrics (ARNX, RTA, SC, GS, and HBE with \(a_1 = 0.06\)) for the eight
NLDR layouts computed on the PBMC3k data, shown as a parallel coordinate
plot. The color of each line corresponds to an NLDR layout. ARNX is
reversed so that lower values indicate better performance. Overall, the
