...
$\mathbfit{x}$ & $p$-dimensional observation ($1\times p$)\\
$\mathbfit{x}^*$ & new $p$-dimensional observation ($1\times p$)\\
$\mathbfit{\hat{X}}$ & $n \times p$-dimensional fitted values\\
$\mathbfit{Y}$ & $n\times k$-dimensional data (layout)\\
$\mathbfit{y}$ & $k$-dimensional obervation ($1\times k$)\\
$\mathbfit{\hat{Y}}$ & $n \times k$-dimensional fitted values\\
