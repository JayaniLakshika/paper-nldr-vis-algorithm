...
\includegraphics[width=1\linewidth,height=0.3\textheight]{appendix_files/figure-pdf/fig-tri-param-1.pdf}
...
\textbf{?@fig-pbmc-mse-umap} shows layout from the original published
