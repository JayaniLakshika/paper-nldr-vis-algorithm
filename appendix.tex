...
compare RMSE with commonly used evaluation metrics such as RTA, ARNX,
sc, and RGS across multiple NLDR layouts. These visual comparisons
highlight that RMSE behaves differently from these existing metrics due
...
layout evaluated using RTA, ARNX, sc, RGS, and RMSE. The metrics show
...
and RGS, is seen as the best by RMSE and sc, while the brown layout,
rated best by ARNX, is seen as the worst by RMSE showing that RMSE
...
represents a layout evaluated using RTA, ARNX, sc, RGS, and RMSE. The
...
the best by ARNX, sc, and RGS, is seen as the worst by RMSE, while the
green layout, rated best by RTA, is seen as the best by RMSE as well.}
