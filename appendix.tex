...
\begin{tabular}{>{\raggedright\arraybackslash}p{1.5cm}>{\raggedright\arraybackslash}p{2cm}l}
\toprule
\textbf{Figure} & \textbf{NLDR method} & \textbf{Hyper-parameter}\\
\midrule
...
$9$a & tSNE & perplexity = 71\\
$9$b & UMAP & n\_neighbors = 15, min\_dist = 0.1\\
$9$c & PaCMAP & n\_neighbors = 10, init = random, MN\_ratio = 0.5, FP\_ratio = 2\\
\midrule
$13$a & tSNE & perplexity = 30\\
\midrule
$13$b & tSNE & perplexity = 89\\
$13$c & UMAP & n\_neighbors = 15, min\_dist = 0.1\\
$13$d & PHATE & knn = 5\\
$13$e & TriMAP & n\_inliers = 12, n\_outliers = 4, n\_random = 3\\
$13$f & PaCMAP & n\_neighbors = 10, init = random, MN\_ratio = 0.5, FP\_ratio = 2\\
...
$9$ & \href{https://youtu.be/I-kxCwVfqiQ}{\texttt{youtu.be/I-kxCwVfqiQ}}, \href{https://youtu.be/gD1P01FUPyU}{\texttt{youtu.be/gD1P01FUPyU}}, \href{https://youtu.be/MxJ_srOFQNk}{\texttt{youtu.be/MxJ\_srOFQNk}}\\
$10$ & \href{https://youtu.be/-KsQH0rII2A}{\texttt{youtu.be/-KsQH0rII2A}}\\
$12$ & \href{https://youtu.be/3VfK3M2gnZM}{\texttt{youtu.be/3VfK3M2gnZM}}, \href{https://youtu.be/Es84bwQcndU}{\texttt{youtu.be/Es84bwQcndU}}\\
$14$ & \href{https://youtu.be/sUcGd57Swdg}{\texttt{youtu.be/sUcGd57Swdg}}, \href{https://youtu.be/QiklCjELUxo}{\texttt{youtu.be/QiklCjELUxo}}\\
\bottomrule
\end{tabular}
\endgroup{}
...
PaCMAP, posisbly along some principal component axes.}
...
sparse end of the sheet into a single corner.}
