...
\bottomrule
\endlastfoot
NA & additional\_functions.R & NA\\
NA & evaluation.py & NA\\
NA & nldr\_code.R & NA\\
\midrule
two\_nonlinear & 01\_gen\_data.R & NA\\
two\_nonlinear & 02\_gen\_true\_model.R & NA\\
two\_nonlinear & 03\_gen\_embeddings.R & NA\\
...
\midrule
mnist & 01\_data\_preprocessing.R & NA\\
mnist & 02\_gen\_diff\_embeddings.R & NA\\
mnist & 03\_gen\_mse\_for\_diff\_methods.R & NA\\
mnist & 04\_gen\_model\_with\_tSNE.R & NA\\
mnist & 05\_evaluation\_metrics.R & NA\\
mnist & 06\_link\_brush\_layout\_e.R & NA\\*
...
represents a layout evaluated using RTA, ARNX, sc, RGS, and HBE. The
...
the best by ARNX, sc, and RGS, is seen as the worst by HBE, while the
...
and RGS across multiple NLDR layouts. These visual comparisons highlight
...
layout evaluated using RTA, ARNX, sc, RGS, and HBE. The metrics show
...
and RGS, is seen as the best by HBE and sc, while the brown layout,
rated best by ARNX, is seen as the worst by HBE showing that HBE
captures a different view of how well the data structure is
represented.}
