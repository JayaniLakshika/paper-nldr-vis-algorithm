...
Figure~\ref{fig-model-pbmc-author-proj-scdeed} shows layout from the
...
\includegraphics[width=0.3\textwidth,height=\textheight]{appendix_files/figure-pdf/fig-model-pbmc-author-proj-scdeed-1.pdf}
