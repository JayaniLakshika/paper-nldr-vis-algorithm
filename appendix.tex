...
\section{Compare evaluation metrics}\label{compare-evaluation-metrics}
...
across eight NLDR layouts for the PBMC data. Each line represents a
different NLDR layout evaluated using multiple normalized metrics: RTA,
AUC(R\_NX), sc, RGS, and RMSE. The variation across metrics shows that
each captures different aspects of structure preservation, and none
behave exactly like RMSE. RTA shows a somewhat similar ordering across
methods.}
...
represents a different NLDR layout evaluated using multiple normalized
metrics: RTA, AUC(R\_NX), sc, RGS, and RMSE. The variation across
metrics shows that each captures different aspects of structure
preservation, and none behave exactly like RMSE. RTA shows a somewhat
similar ordering across methods.}
