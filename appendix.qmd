...
#| fig-cap: "Comparison of scaled evaluation metrics (ARNX, RTA, SC, GS, and HBE with $a_1 = 0.06$) for the eight NLDR layouts computed on the PBMC3k data, shown as a parallel coordinate plot. The color of each line corresponds to an NLDR layout. ARNX is reversed so that lower values indicate better performance. Overall, the metrics show general agreement, with minor differences in ranking. All metrics except SC suggest that layouts d and e outperform layout b. ARNX, GS, and HBE consistently identify layout d as the best, with layout e also performing well."
#| fig-pos: H
#| out-width: 100%
#| fig-height: 6
#| fig-width: 6
