...
#| fig-pos: H
#| out-width: 100%
#| fig-cap: "Comparing the published layout (a) with what would be suggested to be optimal by scDEED (b), using HBE vs $a_1$, on a subset of PBMC3k data. Color represents NLDR layouts. HBE would corroborate that the scDEED optimised layout is better than what was originally published."
...
#| fig-cap: "Comparison of scaled evaluation metrics (ARNX, RTA, SC, GS, and HBE using $a_1=0.05$) for two NLDR layouts of the PBMC3k data—the originally published layout (a) and the scDEED-optimised layout (b). Each line represents a layout, with color matching the corresponding scatterplots. Most metrics (ARNX, RTA, GS, and HBE) consistently indicate that the optimised layout (b) provides a better representation, while SC slightly favors the published layout. Overall, the results align with HBE, supporting that the scDEED-optimised layout offers an improved embedding quality."
#| fig-pos: H
#| out-width: 100%
#| fig-height: 6
#| fig-width: 6
...
#| fig-cap: "Comparison of evaluation metrics across eight NLDR layouts for the MNIST digit 1 data. Each line represents a layout evaluated using RTA, ARNX, sc, GS, and HBE. The metrics show different patterns, meaning no single measure tells the full story of embedding quality. Interestingly, the brown layout, rated the best by ARNX, sc, and GS, is seen as the worst by HBE, while the green layout, rated best by RTA, is seen as the best by HBE as well."
#| fig-pos: H
#| out-width: 100%
#| fig-height: 6
#| fig-width: 6
