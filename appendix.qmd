...
The layout a (@fig-pbmc-mse-umap) is generated from the hyper-parameters suggested by @chen2023, and the layout b (@fig-pbmc-mse-umap) is with suggested hyper-parameters by scDEED to be more accurate. The layout a and b contain $46$ and $83$ dubious cells respectively. 
