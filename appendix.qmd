...
comp_metrics_pbmc_scdeed <- ggparcoord(
  data = nldr_metrics,
  columns = c(5,8,3,2,7),           # numeric columns to plot
...
comp_metrics_pbmc <- ggparcoord(
  data = nldr_metrics,
  columns = c(5,3,8,2,7),           # numeric columns to plot
  groupColumn = 1,         # color by method
  scale = "uniminmax"      # normalize between 0 and 1 for fair comparison
) +
  scale_color_manual(
...
#| fig-cap: "Comparison of evaluation metrics across eight NLDR layouts for the PBMC3k data. Each line represents a layout evaluated using RTA, ARNX, sc, GS, and HBE. The metrics show different patterns, meaning no single measure tells the full story of embedding quality. Interestingly, the green layout, rated worst by ARNX and GS, is seen as the best by HBE and sc, while the brown layout, rated best by ARNX, is seen as the worst by HBE showing that HBE captures a different view of how well the data structure is represented."
#| fig-pos: H
#| out-width: 100%
#| fig-height: 6
#| fig-width: 6
...
comp_metrics_mnist <- ggparcoord(
  data = nldr_metrics,
  columns = c(5,8,2,3,7),           # numeric columns to plot
  groupColumn = 1,         # color by method
  scale = "uniminmax"      # normalize between 0 and 1 for fair comparison
) +
  scale_color_manual(
