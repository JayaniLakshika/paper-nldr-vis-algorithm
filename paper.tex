...
two of them close and one is separated from others. This is why b1, b2,
and b3 shows a connected edge between the close clusters, as proven by
Figure~\ref{fig-pbmc-mse} as a best layout. Viewing the fitted model in
\(9\text{-}D\), helps to see some unobserved patterns of the data: (i)
dense points, and (ii) non-linear clusters. Videos of the langevitour
animations for the models are available at
\url{https://youtu.be/0cKX_HG_n0k} and respectively.}
