...
\caption{\label{fig-NLDR-scurve}Key steps for constructing the \(2-D\)
model for S-curve data: (a) obtain UMAP data, (b) hexagonating UMAP
data, (c) obtain hexagonal bin centroids, and (d) triangulate bin
centroids.}
