...
two C-shaped clusters data (grey points). The data is spread along the
...
\subsubsection{Relative proportion
density}\label{relative-proportion-density}
...
and \(0.12\). The relative proportion density decreases and levels off.
...
edge lengths, based on bin widths. \textbf{?@fig-rm-lg} illustrates edge
...
layouts on the two C-shaped clusters data is the better representation
