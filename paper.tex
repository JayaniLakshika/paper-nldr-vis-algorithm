...
visualizing the \emph{model-in-th-data-space} some unobserved structures
can be seen. Some clusters have non-linear continuity patterns and
high-density patches (Figure~\ref{fig-model-pbmc-author-proj}).
...
for the PBMC3k data (\(b = 870   (30,  29)\), \(m = 135\), benchmark
value to remove large edges is \(0.099\)) The full video is available at
