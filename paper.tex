...
{\centering \includegraphics[width=1\textwidth,height=\textheight]{paper_files/figure-pdf/NLDR-variety-1.pdf}

}

\caption{Six different NLDR representations of the same data. Different
techniques and different parameter choices are used. Which is the most
accurate representation of the structure in high dimensions?}
