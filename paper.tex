...
and breaks on \(x_1\), is calculated as
...
\(b_2\), and vertical binwidth, which are computed based on \(r_2\), and
the height/width ratio of a regular hexagon, \(\frac{2}{\sqrt{3}}\) as
