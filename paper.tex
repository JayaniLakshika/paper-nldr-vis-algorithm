...
These \texttt{R} packages were used for the work:. These \texttt{python}
packages were used for the work:. The article was created with
\texttt{R} packages \texttt{rticles}, \texttt{knitr}, and
\texttt{rmarkdown}. The project's GitHub repository
