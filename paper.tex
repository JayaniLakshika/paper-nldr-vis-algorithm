...
\subsubsection{Residuals and error}\label{residuals-and-error}
...
\caption{\label{fig-lwd-scurve}Two approaches to identify low-density
hexagons. Hexagon grid (a) marks hexagons with a standardized count less
than \(0.25\). Hexagon grid (b) marks hexagons by considering the
densities of neighboring bins. Removing hexagons by also investigating
the densities of neighboring bins is more reliable for preserving the
structure.}
