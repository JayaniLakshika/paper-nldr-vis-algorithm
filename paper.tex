...
{\centering \includegraphics{paper_files/figure-pdf/fig-diagnosticpltScurvelgrm-1.pdf}
...
\toprule\noalign{}
n\_neighbors & min\_dist & metric & error \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
\textbf{30} & \textbf{0.3} & \textbf{cosine} &
\textbf{38634.66719286174} \\
...
(n\_neighbors = 15, min\_dist = 0.99, metric = euclidean) applied for
the PBMC3k dataset. Is this a best representation of the original data?,
(b) Model in the 2D space with UMAP (\textless\textgreater)}
...
{\centering \includegraphics[width=1\textwidth,height=\textheight]{paper_files/figure-pdf/fig-nldervisPBMCtSNE1-1.pdf}

}

\caption{\label{fig-nldervisPBMCtSNE1}(a) 2D layout from tSNE
(perplexity = 5) applied for the PBMC3k dataset. Is this a best
representation of the original data?, (b) Model in the 2D space with
tSNE (\textless\textgreater)}

\end{figure}

\begin{figure}[h]

{\centering \includegraphics[width=1\textwidth,height=\textheight]{paper_files/figure-pdf/fig-nldervisPBMCtSNE2-1.pdf}

}

\caption{\label{fig-nldervisPBMCtSNE2}(a) 2D layout from tSNE
(perplexity = 2) applied for the PBMC3k dataset. Is this a best
representation of the original data?, (b) Model in the 2D space with
tSNE (\textless\textgreater)}
