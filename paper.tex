...
animation is available at \url{https://youtu.be/yN-RNPV_cHQ}.}
...
\hypertarget{remove-low-density-hexagons}{%
\subsubsection{Remove low-density
hexagons}\label{remove-low-density-hexagons}}
...
\subsubsection{Remove long edges}\label{remove-long-edges}}
