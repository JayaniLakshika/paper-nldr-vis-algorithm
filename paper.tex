...
(see \textbf{?@fig-binsize} (a)), while if there are too many bins, it
...
appropriate number of bins to construct an effective model.
...
\textbf{?@fig-diagnostic1-scurve}).

\begin{figure}[H]

\centering{

\includegraphics[width=0.5\textwidth,height=\textheight]{paper_files/figure-pdf/fig-mse-scurve-b-1.pdf}
...
\includegraphics[width=0.5\textwidth,height=\textheight]{paper_files/figure-pdf/fig-mse-scurve-lwd-1.pdf}
