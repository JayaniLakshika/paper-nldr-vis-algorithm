...
PBMC3k data. (The \textbf{langevitour} software is used to view the data
...
digit 1 of MNIST data. (The \textbf{langevitour} software is used to
view the data with a tour, and the full video is available at
