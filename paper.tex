...
\includegraphics[width=1\textwidth,height=0.22\textheight]{paper_files/figure-pdf/fig-model-mnist-1.pdf}
...
them anomalies (Figure~\ref{fig-model-mnist}). These anomalies can be
