...
\(\frac{2}{\sqrt{3}}\) accounts for the different height (\(a_1\)) and
width (\(a_2\)) of a regular hexagon.) (Figure~\ref{fig-NLDR-scurve}
(a))
...
fixed height (\(a_1\)), width (\(a_2\)), it is necessary to determine
...
and the height (\(a_1\)) and width (\(a_2\)) of a regular hexagon
(Figure~\ref{fig-NLDR-scurve} (b)). (\(b_1 = \frac{r_1 + q_1}{a_2}\),
and \(b_2 = \frac{r_2 + q_2}{0.75 \times a_1}\)) where
\(0.75 \times a_1\) accommodate to have hexagons fill the entire 2D
