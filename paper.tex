...
were used for the work: \texttt{trimap} and \texttt{pacmap}. The article
was created with \texttt{R} packages \texttt{rticles}
(\citet{jjallaire2024}), \texttt{knitr} (\citet{yihui2014}), and
\texttt{rmarkdown} (\citet{yihui2020}). The project's GitHub repository
