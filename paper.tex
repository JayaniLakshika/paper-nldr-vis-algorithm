...
As shown in Figure~\ref{fig-NLDR-variety} (e), there are three
...
within the clusters (Figure~\ref{fig-NLDR-variety} (e)). This
demonstrates that tSNE accurately captures the data structure of the
PBMC3k dataset, which UMAP did not achieve.
