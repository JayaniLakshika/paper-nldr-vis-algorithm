...
\includegraphics{figures/scurve/sc_true_1.png}\end{minipage}%
%
\begin{minipage}{0.33\linewidth}
\includegraphics{figures/scurve/sc_true_2.png}\end{minipage}%
%
\begin{minipage}{0.33\linewidth}
\includegraphics{figures/scurve/sc_true_3.png}\end{minipage}%
...
(\url{https://youtu.be/bcQg4XcRjhc}).}
...
the full video is available at (\url{https://youtu.be/G1m4q9k--v4}).
NEED TO CHANGE FIRST PLOT TO BE 2D WIREFRAME.}
...
\begin{center}
\includegraphics[width=1\textwidth,height=\textheight]{paper_files/figure-pdf/unnamed-chunk-15-1.pdf}
\end{center}
...
the S-curve data, using three different bin inputs: (a) \(b = 91\) (7,
13), (b) \(b = 190\) (10, 19), and (c) \(b = 364\) (14, 26). Color
...
{\centering \includegraphics[width=1\textwidth,height=\textheight]{paper_files/figure-pdf/unnamed-chunk-32-1.pdf}
...
XXX BEST FIT FOR S-CURVE MIGHT BE A DIFFERENT NLDR. SHOW THE SEVERAL
SUB-OPTIMAL FITS.
...
XXX THIS IS NOT INTERESTING IN ITS CURRENT FORM. THIS IS ONLY ANY
INTERESTING EXAMPLE WHEN THE FILLED OUT VS FLAT SHAPES ARE DISCUSSED.
...
\caption{\label{fig-gau-tsne-sc}Screen shots of the \textbf{langevitour}
of the five Gaussian clusters dataset, shows the model with tSNE in
...
\caption{\label{fig-gau-umap-sc}Screen shots of the \textbf{langevitour}
of the five Gaussian clusters dataset, shows the model with UMAP in
\pD{}, a video of the tour animation is available at
...
\caption{\label{fig-gau-pacmap-sc}Screen shots of the
\textbf{langevitour} of the five Gaussian clusters dataset, shows the
model with PaCMAP in \pD{}, a video of the tour animation is available
at (\url{https://youtu.be/z07cKXi8EJQ}).}
...
In the \gD{} layouts generated by various NLDR techniques, as shown in
