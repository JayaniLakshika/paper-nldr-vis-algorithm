...
\captionsetup{labelsep=none}\includegraphics{figures/scurve/sc_1.png}

}

\subcaption{\label{fig-scurve_sc1}}
...
\captionsetup{labelsep=none}\includegraphics{figures/scurve/sc_2.png}
...
\captionsetup{labelsep=none}\includegraphics{figures/scurve/sc_3.png}
...
(see Figure~\ref{fig-gau1_sc}, Figure~\ref{fig-gau2_sc}, and
Figure~\ref{fig-gau3_sc}). On the other hand, both TriMAP and PaCMAP
show clusters with flat surfaces, suggesting a failure to capture
within-cluster variation (see Figure~\ref{fig-gau4_sc} and
Figure~\ref{fig-gau5_sc}). Therefore, TriMAP and PaCMAP do not capture
