...
points indicating bin means) constructed from the UMAP layout, with XXX
bins (using the \textbf{langevitour} software). The model closely fits
the shape of this data. A video of the full tour is available at
(\url{https://youtu.be/G1m4q9k--v4}).}
...
places and mismatches the pattern (Figure~\ref{fig-scurve-sc-bad}).
...
\caption{\label{fig-scurve-sc-best}Screen shots of the
...
\caption{\label{fig-scurve-sc-bad}Screen shots of the
\textbf{langevitour} of the S-curve, shows the model-in-data space, a
video of the tour animation is available at
