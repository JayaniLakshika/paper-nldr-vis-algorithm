...
smaller than the minimum data value. This is computed as one buffer
unit, \(q\) below the minimum data value, by default. The user provides
the preferred number of bins in the horizontal direction, \(b_1\), and
the algorithm computes the appropriate number of bins in the vertical
direction, \(b_2\).
