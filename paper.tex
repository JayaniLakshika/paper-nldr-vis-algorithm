...
\includegraphics[width=1\textwidth,height=0.3\textheight]{paper_files/figure-pdf/fig-bin-counts-scurve-with_buffer-1.pdf}

}

\caption{\label{fig-bin-counts-scurve-with_buffer}Distribution of bin
counts for differnt \(b_1\) with specific \(q\)}

\end{figure}%

\begin{center}
\includegraphics[width=1\textwidth,height=0.3\textheight]{paper_files/figure-pdf/unnamed-chunk-34-1.pdf}
\end{center}

\begin{center}
\includegraphics[width=1\textwidth,height=0.3\textheight]{paper_files/figure-pdf/unnamed-chunk-35-1.pdf}
\end{center}

\begin{center}
\includegraphics[width=1\textwidth,height=\textheight]{paper_files/figure-pdf/unnamed-chunk-36-1.pdf}
\end{center}
...
\includegraphics[width=0.7\textwidth,height=\textheight]{paper_files/figure-pdf/fig-pbmc-mse-1.pdf}
...
\begin{center}
\includegraphics[width=1\textwidth,height=\textheight]{paper_files/figure-pdf/unnamed-chunk-66-1.pdf}
\end{center}
