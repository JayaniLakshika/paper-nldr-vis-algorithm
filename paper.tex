...
two-curvy data (black points). The data is spread along the S shape, and
...
\caption{\label{fig-two_curvy-sc-best}Model in \gD{}, on the tSNE
layout, and three views of the fit in projections from \(7\text{-}D\),
for the S-curve data (\((s_1, \ s_2) = (-0.170, \ -0.137)\),
