...
reproduction of the published plot. The objective is to select a
reasonable \gD{} layout, representing the three close clusters of the
PBMC3k dataset in \(9\text{-}D\)
(Figure~\ref{fig-model-pbmc-author-proj} (a2)).
