...
in projections of the \(7\text{-}D\) space. In these projection the
difference between the distribution of high-dimensional model error can
be seen. The uniform densed C-shaped cluster

\begin{figure}[H]

\centering{

\includegraphics[width=1\textwidth,height=\textheight]{paper_files/figure-pdf/fig-one-dens_clust-error-1.pdf}
