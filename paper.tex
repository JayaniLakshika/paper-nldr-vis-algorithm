...
\caption{\label{fig-one-dens_clust-error}All \gD{} layouts show high
error in the sparse end. Three \gD{} layouts: (a) tSNE, (b) UMAP, (c)
PaCMaP of C-shaped densed cluster coloured by high-dimensional absolute
error. Darker color shows high error while light colors shows low
errors. Irrespective of the NLDR method, dense end of the structure
shows the low error while sparse end of the structure shows the high
error, because.}
