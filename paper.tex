...
\includegraphics[width=1\textwidth,height=0.6\textheight]{paper_files/figure-pdf/fig-two_curvy_diff_clust-mse-1.pdf}

}

\caption{\label{fig-two_curvy_diff_clust-mse}Assessing which of the 5
NLDR layouts on the two C-shaped clusters data is the better
...
NLDR layout (a-e). Layout d is universally poor. Layouts a that show two
