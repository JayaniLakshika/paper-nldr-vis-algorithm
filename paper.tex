...
\includegraphics[width=1\textwidth,height=0.6\textheight]{paper_files/figure-pdf/fig-two_c_shaped_clust-mse-1.pdf}

}

\caption{\label{fig-two_c_shaped_clust-mse}Assessing which of the 5 NLDR
