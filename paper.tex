...
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[enhanced, sharp corners, borderline west={3pt}{0pt}{shadecolor}, interior hidden, boxrule=0pt, frame hidden, breakable]}{\end{tcolorbox}}\fi
...
\hypertarget{hexagonal-grid-starting-point}{%
\subsubsection{Hexagonal grid starting
point}\label{hexagonal-grid-starting-point}}

Mainly hexagonal grid starts at the lowest x and y values assign for the
grid. Another possibility is to shift the grid. That's another
interesting parameter to investigate.

\includegraphics{paper_files/figure-pdf/unnamed-chunk-39-1.pdf}

\includegraphics{paper_files/figure-pdf/unnamed-chunk-39-2.pdf}

\includegraphics{paper_files/figure-pdf/unnamed-chunk-39-3.pdf}

\includegraphics{paper_files/figure-pdf/unnamed-chunk-39-4.pdf}

Compute aic, mse after shifting and compare before and after shifting
errors And investigate how aic, mse change according to the shifted
amount
