...
data <- read_rds(here::here("data/two_curvy_diff_clust/two_curvy_diff_clust_data.rds"))
...
write_rds(tSNE_data, file = paste0("data/two_curvy_diff_clust/two_curvy_diff_clust_tsne_perplexity_", perplexity, ".rds"))
...
write_rds(PHATE_data, file = paste0("data/two_curvy_diff_clust/two_curvy_diff_clust_phate_knn_", knn, ".rds"))
...
write_rds(TriMAP_data, file = paste0("data/two_curvy_diff_clust/two_curvy_diff_clust_trimap_n-inliers_", n_inliers, "_n-outliers_", n_outliers, "_n-random_", n_random, ".rds"))
...
write_rds(PacMAP_data, file = paste0("data/two_curvy_diff_clust/two_curvy_diff_clust_pacmap_n-neighbors_", n_neighbors,"_init_", init, "_MN-ratio_", MN_ratio, "_FP-ratio_", FP_ratio, ".rds"))
