...
data <- read_rds("data/s_curve/scurve_simulated_5000.rds")
...
UMAP_fit <- umap(data, n_neighbors = 50, n_components =  2)
...
## Run only once
write_rds(UMAP_data, file = "data/s_curve/s_curve_umap_5000.rds")
...
#
# ## Run only once
# write_rds(UMAP_data, file = "data/s_curve/s_curve_umap_predict_5000.rds")
