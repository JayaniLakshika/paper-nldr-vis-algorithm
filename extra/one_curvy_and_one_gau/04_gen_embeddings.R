...
data <- read_rds(here::here("data/one_curvy_one_gau_clust/one_curvy_one_gau_clust_data.rds"))
...
write_rds(tSNE_data, file = paste0("data/one_curvy_one_gau_clust/one_curvy_one_gau_clust_tsne_perplexity_", perplexity, ".rds"))
...
## Run only once
write_rds(UMAP_data, file = paste0("data/one_curvy_one_gau_clust/one_curvy_one_gau_clust_umap_n-neigbors_", n_neighbors, "_min-dist_", min_dist, ".rds"))

## Predict for true model
# true_model_data <- read_rds("data/one_curvy_one_gau_clust/one_curvy_one_gau_clust_true_model.rds")
...
#
# ## Run only once
# write_rds(predict_UMAP_df, file = "data/one_curvy_one_gau_clust/one_curvy_one_gau_clust_umap_predict_true.rds")
...
write_rds(PHATE_data, file = paste0("data/one_curvy_one_gau_clust/one_curvy_one_gau_clust_phate_knn_", knn, ".rds"))
...
write_rds(TriMAP_data, file = paste0("data/one_curvy_one_gau_clust/one_curvy_one_gau_clust_trimap_n-inliers_", n_inliers, "_n-outliers_", n_outliers, "_n-random_", n_random, ".rds"))
...
write_rds(PacMAP_data, file = paste0("data/one_curvy_one_gau_clust/one_curvy_one_gau_clust_pacmap_n-neighbors_", n_neighbors,"_init_", init, "_MN-ratio_", MN_ratio, "_FP-ratio_", FP_ratio, ".rds"))
