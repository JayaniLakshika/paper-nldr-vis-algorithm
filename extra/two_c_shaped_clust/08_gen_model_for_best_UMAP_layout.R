...
## Import data
training_data_two_nonlinear_clusters <- read_rds("data/two_c_shaped_clust/two_c_shaped_clust_data.rds")
...
UMAP_two_nonlinear_clusters <- read_rds("data/two_c_shaped_clust/two_c_shaped_clust_umap_n-neigbors_15_min-dist_0.1.rds")
...
error_df_two_curvy_abs <- error_df_two_curvy_abs |>
  bind_cols(UMAP_two_nonlinear_clusters_scaled |>
              select(-ID))
