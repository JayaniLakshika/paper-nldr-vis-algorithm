...
true_model_data <- read_rds("data/two_curvy_clust/two_curvy_clust_true_model.rds")
...
## Run only once
write_rds(predict_UMAP_df, file = "data/two_curvy_clust/two_curvy_clust_umap_predict_true.rds")
