...
mse_two_curvy_b <- ggplot(error_two_curvy_umap, 
  ...
  geom_point(size = 1) +
  scale_x_continuous(breaks = sort(unique(round(error_two_curvy_umap$a1, 2)))[c(2, 4, 8, 11, 13, 14, 15, 16)]) +
