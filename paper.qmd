...
When $k=2$ which is assumed for hexagon binning, $(y_{1,\text{max}}=1$ and $y_{2,\text{max}} = \frac{r_2}{r_1}\times \frac{2}{\sqrt{3}}$. (The $\frac{2}{\sqrt{3}}$ accounts for the different height and width of a regular hexagon.)
