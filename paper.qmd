...
```{r}
#| label: pair-wise-dist-two-curvy

dist_comp1 <- read_rds("data/two_nonlinear/dist_comp_bin_13.rds") |>
  as.tibble()

dist_cmp_plt1 <- ggplot(dist_comp1, 
                                  aes(x = umap_test, y = quollr_predict)) +
  geom_point(alpha = 0.05, colour = "#000000", size = 0.5) +
  interior_annotation(label = "a2", sc_ltr_pos, cex = 1.5) +
  xlab("distance in UMAP") +
  ylab("distance in predict") +
  theme_minimal() +
...
dist_comp2 <- read_rds("data/two_nonlinear/dist_comp_bin_30.rds") |>
  as.tibble()

dist_cmp_plt2 <- ggplot(dist_comp2, 
                                  aes(x = umap_test, y = quollr_predict)) +
  geom_point(alpha = 0.05, colour = "#000000", size = 0.5) +
  interior_annotation(label = "b2", sc_ltr_pos, cex = 1.5) +
  xlab("distance in UMAP") +
  ylab("distance in predict") +
  theme_minimal() +
  theme(panel.border = element_rect(fill = 'transparent'),
...
dist_comp3 <- read_rds("data/two_nonlinear/dist_comp_bin_54.rds") |>
  as.tibble()

dist_cmp_plt3 <- ggplot(dist_comp3, 
                                  aes(x = umap_test, y = quollr_predict)) +
  geom_point(alpha = 0.05, colour = "#000000", size = 0.5) +
  interior_annotation(label = "c2", sc_ltr_pos, cex = 1.5) +
  xlab("distance in UMAP") +
  ylab("distance in predict") +
  theme_minimal() +
  theme(panel.border = element_rect(fill = 'transparent'),
...
```{r}
dist_comp1 <- read_rds("data/two_nonlinear/dist_comp_bin_13_org.rds") |>
  as.tibble()

dist_cmp_plt11 <- ggplot(dist_comp1, 
                                  aes(x = umap_test, y = quollr_predict)) +
  geom_point(alpha = 0.05, colour = "#000000", size = 0.5) +
  interior_annotation(label = "a2", sc_ltr_pos, cex = 1.5) +
  xlab("distance in UMAP") +
...
dist_comp2 <- read_rds("data/two_nonlinear/dist_comp_bin_30_org.rds") |>
  as.tibble()

dist_cmp_plt21 <- ggplot(dist_comp2, 
                                  aes(x = umap_test, y = quollr_predict)) +
  geom_point(alpha = 0.05, colour = "#000000", size = 0.5) +
  interior_annotation(label = "b2", sc_ltr_pos, cex = 1.5) +
  xlab("distance in UMAP") +
...
dist_comp3 <- read_rds("data/two_nonlinear/dist_comp_bin_54_org.rds") |>
  as.tibble()

dist_cmp_plt31 <- ggplot(dist_comp3, 
                                  aes(x = umap_test, y = quollr_predict)) +
  geom_point(alpha = 0.05, colour = "#000000", size = 0.5) +
  interior_annotation(label = "c2", sc_ltr_pos, cex = 1.5) +
  xlab("distance in UMAP") +
...
test_two_curvy_umap1 + test_two_curvy_umap2 + test_two_curvy_umap3 +
  dist_cmp_plt1 + dist_cmp_plt2 + dist_cmp_plt3 +
  test_two_curvy_umap11 + test_two_curvy_umap21 + test_two_curvy_umap31 +
  dist_cmp_plt11 + dist_cmp_plt21 + dist_cmp_plt31 +
  plot_layout(ncol = 3)
```
