...
mnist_proj_tsne_model1 <- plot_proj(
  ...
  axes = axes, 
  circle = circle, 
  point_param = c(0.5, 0.5, "#000000"), # size, alpha, color
  line_param = c(0.5, 0.5), # linewidth, alpha
...
mnist_proj_tsne_model1_link <- projected_df |>
  ggplot(
    aes(
      x = proj1, 
      y = proj2,
...
mnist_proj_tsne_model2 <- projected_df |>
  ...
  xlim(c(-1, 1)) +
  ylim(c(-1, 1)) +
  interior_annotation("c", cex = 1.5) +
  theme(
    legend.position = "none"
  )

mnist_proj_tsne_model2_link <- projected_df |>
  ggplot(
    aes(
      x = proj1, 
      y = proj2,
