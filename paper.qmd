...
distance_df_small_edges_gau1 <- distance_gau1 |>
  filter(distance < benchmark_gau1) #|> benchmark_gau1
  #mutate(ID = row_number()) #|>
  #filter(!(ID %in% c(112)))
...
imge_error_sample_inside <- plot_digit_img(pixels_gathered_inside, palette = "Oranges", title_text = "(e)", hjust = 0, ncol = 9)
