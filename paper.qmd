...
source("scripts/one_c_shaped_dens_structure/04_gen_error_plots.R")
source("scripts/two_non_linear_diff_shaped_close_clusters/10_gen_rm_lg_plots.R")
```
...
error_df_one_curvy_abs <- augment(
  df_bin_centroids = df_bin_centroids_dens_clust,
  df_bin = df_bin_dens_clust,
...
projected_df <- projected_df |>
  mutate(cluster = error_df_one_curvy_abs$error_cat_n2)
