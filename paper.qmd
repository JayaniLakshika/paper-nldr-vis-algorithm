...
gen_axes <- function(proj, limits = 1, axis_pos_x = NULL, axis_pos_y = NULL, axis_labels) {
...
axes_obj <- gen_axes(
  proj = projection_filtered,
  limits = 1.5,
  axis_pos_x = -0.75,
  axis_pos_y = -0.75,
  axis_labels = paste0("p", rows_to_keep))
...
projection <- cbind(
    ...
    c(0.00587,0.71879,0.03485,0.08284,-0.07534,-0.05420,0.04315,-0.00547,-0.02995,0.01810)) * 1.3
...
projection <- cbind(
    ...
    c(0.53615,0.14969,-0.09393,-0.20053,0.07992,-0.34791,0.13057,-0.06814,-0.16737,0.03716)) * 2
...
projection <- cbind(
    ...
    c(-0.42542,0.29570,0.31106,-0.30307,0.00614,0.16714,0.21779,-0.00025,0.07020,-0.00689)) * 1.5
