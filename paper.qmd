...
highd_error_2d_mnist <- error_df |>
  ...
  geom_rect(aes(xmin = 0.35, xmax = 0.45, ymin = 0.55, ymax = 0.7),
               fill = "transparent", color = "#008000", linewidth = 1)  +
...
#| fig-cap: "The $10\\text{-}D$ model error in \\gD{} layout of the MNIST digit 1 data shows a pattern. Most low model errors are distributed along the big non-linear cluster, while most large model errors are distributed along the small cluster. The images associated with large model errors shows different patterns of digit 1, some inside (f) the non-linear structure and others outside (e). Along the non-linear cluster, the angle of digit 1 changes (b-d)."
#| fig-pos: H
#| fig-width: 10
#| fig-height: 10
#| out-width: 100%
