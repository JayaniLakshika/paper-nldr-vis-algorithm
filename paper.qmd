...
#| fig-cap: "Model in \\gD{}, on the layout and two views of the fit in projections from $7\\text{-}D$, for the two-curvy clusters data ($n =  2000$ and $p = 7$). The fitted model"
#| fig-width: 10
#| fig-height: 10
