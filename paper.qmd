...
Delaunay triangulation [@lee1980, @albrecht2024] is used to connect neighboring centroids. The edges are needed to preserve neighborhood information when the model is lifted into \pD{}. 
