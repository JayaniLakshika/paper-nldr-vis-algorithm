...
error_plot_pbmc <- ggplot(error_pbmc, 
  ...
  scale_color_manual(values=c('#ff7f00', '#984ea3', 
                              '#999999', '#a65628', '#f781bf')) +
  ylab("absolute error (in thousands)") +
