...
result_umap <- result_umap |>
  mutate(plot = c("b", "i", "h", "g", "f", "a", "e", "c", "d")) |>
  arrange(number_dubious_cells)
...
umap_pbmc2 <- read_rds("data/pbmc3k/pbmc_scdeed_umap_n_neighbors_5_min_dist_0.01.rds")
...
umap_pbmc3 <- read_rds("data/pbmc3k/pbmc_scdeed_umap_n_neighbors_15_min_dist_0.99.rds")
umap_pbmc3 <- as_tibble(umap_pbmc3)
names(umap_pbmc3) <- c("UMAP1", "UMAP2")
...
umap_pbmc4 <- read_rds("data/pbmc3k/pbmc_scdeed_umap_n_neighbors_30_min_dist_0.99.rds")
umap_pbmc4 <- as_tibble(umap_pbmc4)
names(umap_pbmc4) <- c("UMAP1", "UMAP2")

nldr4c <- umap_pbmc4 |>
  ggplot(aes(x = UMAP1,
             y = UMAP2))+
  geom_point(alpha=0.1, size=1, colour='#8dd3c7') +
  interior_annotation("d")

umap_pbmc5 <- read_rds("data/pbmc3k/pbmc_scdeed_umap_n_neighbors_5_min_dist_0.99.rds")
umap_pbmc5 <- as_tibble(umap_pbmc5)
names(umap_pbmc5) <- c("UMAP1", "UMAP2")
...
umap_pbmc6 <- read_rds("data/pbmc3k/pbmc_scdeed_umap_n_neighbors_15_min_dist_0.3.rds")
umap_pbmc6 <- as_tibble(umap_pbmc6)
names(umap_pbmc6) <- c("UMAP1", "UMAP2")
...
umap_pbmc7 <- read_rds("data/pbmc3k/pbmc_scdeed_umap_n_neighbors_5_min_dist_0.3.rds")
umap_pbmc7 <- as_tibble(umap_pbmc7)
names(umap_pbmc7) <- c("UMAP1", "UMAP2")
...
umap_pbmc8 <- read_rds("data/pbmc3k/pbmc_scdeed_umap_n_neighbors_30_min_dist_0.01.rds")
umap_pbmc8 <- as_tibble(umap_pbmc8)
names(umap_pbmc8) <- c("UMAP1", "UMAP2")
...
umap_pbmc9 <- read_rds("data/pbmc3k/pbmc_scdeed_umap_n_neighbors_15_min_dist_0.01.rds")
umap_pbmc9 <- as_tibble(umap_pbmc9)
names(umap_pbmc9) <- c("UMAP1", "UMAP2")

nldr9c <- umap_pbmc9 |>
  ggplot(aes(x = UMAP1,
             y = UMAP2))+
  geom_point(alpha=0.1, size=1, colour='#e41a1c') +
  interior_annotation("i")
```
...
error_pbmc_umap2 <- read_rds("data/pbmc3k/error_scdeed_pbmc_umap_5_min_dist_0.01.rds")
error_pbmc_umap3 <- read_rds("data/pbmc3k/error_scdeed_pbmc_umap_15_min_dist_0.99.rds")
error_pbmc_umap4 <- read_rds("data/pbmc3k/error_scdeed_pbmc_umap_30_min_dist_0.99.rds")
error_pbmc_umap5 <- read_rds("data/pbmc3k/error_scdeed_pbmc_umap_5_min_dist_0.99.rds")
error_pbmc_umap6 <- read_rds("data/pbmc3k/error_scdeed_pbmc_umap_15_min_dist_0.3.rds")
error_pbmc_umap7 <- read_rds("data/pbmc3k/error_scdeed_pbmc_umap_5_min_dist_0.3.rds")
error_pbmc_umap8 <- read_rds("data/pbmc3k/error_scdeed_pbmc_umap_30_min_dist_0.01.rds")
error_pbmc_umap9 <- read_rds("data/pbmc3k/error_scdeed_pbmc_umap_15_min_dist_0.01.rds")
...
error_umap_plot_pbmc <- ggplot(error_pbmc, 
  ...
  #            color = "black", linewidth=0.8, alpha = 0.5) +
  scale_x_continuous(breaks = sort(unique(error_pbmc$a1))[c(1, 5, 9, 13, 17, 21, 26)]) +
  scale_color_manual(values=c('#e41a1c','#377eb8','#4daf4a','#984ea3','#ff7f00','#8dd3c7','#a65628','#f781bf','#999999')) +
  scale_y_log10() +
  ylab("log(MSE)") +
  xlab(expression(paste("binwidth (", a[1], ")"))) +
  theme_minimal() +
...
free(error_umap_plot_pbmc) + wrap_plots(nldr1c, nldr2c, nldr3c, nldr4c, nldr5c, nldr6c, nldr7c, nldr8c, nldr9c, ncol = 2)
```
