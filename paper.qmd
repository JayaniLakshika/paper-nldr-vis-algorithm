...
```{r}
#| label: diff-bins-scurve
## To initialize benchmark values to remove low density hexagons
benchmark_rm_hex_vec <- seq(0, 0.8, by=0.1)
...
bin_width <- hb_obj_scurve$centroids$c_x[2]-hb_obj_scurve2$centroids$c_x[1]
