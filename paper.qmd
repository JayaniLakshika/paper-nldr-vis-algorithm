...
#| fig-pos: H
#| out-height: 100%
#| fig-cap: "Assessing which of the 2 tSNE layouts with different perplexity ($30$ (red), $320$ (blue)) on the PBMC data is the better representation using MSE for varying binwidth ($a_1$). Colour  used for the lines and points in the left plot and in the scatterplots represents tSNE layout (a, b). Layout b is universally suboptimal. Layout b is the best choice."
...
```{r}
#| echo: false
#| fig-cap: "Model in \\gD{}, on the layout a, and two views of the fit in projections from $50\\text{-}D$, for the PBMC3k data ($n =  5858$ and $p = 50$). Layout shows close clusters. In $50\\text{-}D$, the data shows "
