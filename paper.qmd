...
imge_error_sample_inside <- plot_digit_img(
  pixels_gathered_inside, palette = "Oranges", title_text = "e", ncol = 3)
...
top_layout <- wrap_plots(right_top_img, middle_img, right_bottom_img, imge_error_sample_outside, nrow = 4) + theme(plot.margin = margin(0, 0, 0, 0))
...
# /imge_error_sample_inside + plot_layout(widths = c(1, 1), 
#                                                    heights = c(1, 0.2))
```
