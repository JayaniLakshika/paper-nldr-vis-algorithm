...
```{r}
#| echo: false
#| fig-cap: "2D layout from UMAP (n_neighbors = 5, min_dist = 0.99, metric = cosine) applied for PBMC3k dataset (a) colored by manualy identified clusters, (b) colored by `detour` results"
