...
true_model_df_std <- read_rds("data/two_non_linear_diff_shaped_close_clusters/two_non_linear_diff_shaped_close_clusters_true_model_std.rds")
...
training_data_two_curvy_not_std <- read_rds("data/two_non_linear_diff_shaped_close_clusters/two_non_linear_diff_shaped_close_clusters_data_without_std.rds")

data_two_curvy <- training_data_two_curvy |>
  mutate(type = "data")

data_two_curvy_not_std <- training_data_two_curvy_not_std |>
  mutate(type = "data")

true_model_two_curvy_std <- true_model_df_std |> 
  select(-ID) |> 
...
scaled_two_curvy_data_true_model <- df_model_data_two_curvy |>
...
# Apply the scaling
df_model_data_two_curvy <- bind_rows(data_two_curvy_not_std, true_model_two_curvy)
...
## First projection
projection <- cbind(
    c(0.11062,-0.02743,0.02786,-0.01930),
    c(-0.01110,-0.06886,0.04730,0.09890))
