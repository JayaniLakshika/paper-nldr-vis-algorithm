...
df_b_two_curvy <- avg_highd_data(data = df_all_two_curvy, col_start = "x")
...
# proj_plot_two_curvy_true + plot_predict_umap_two_curvy + 
#   plot_predict_umap_two_curvy + plot_predict_umap_connect_two_curvy +
#   plot_layout(ncol = 4)
proj_plot_two_curvy_true
```
