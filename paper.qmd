...
```{r}
#| label: fig-rm-lg
#| fig-cap: "Distribution of edge lengths and wireframes in \\gD{} and $7\\text{-}D$ with Delaunay triangulation, and two choices of long edge removal: (b) benchmark = 2.5$a_1$ and (c) benchmark = 2$a_1$, where $a_1$ = 0.09."
#| fig-height: 15
#| fig-width: 15
