...
projected_df_n <- as.matrix(true_model_df_rm_id) %*% projection |> 
  as_tibble(.name_repair = "unique") |> 
  rename(c("proj1" = "...1", 
           "proj2" = "...2"))
