...
proj_obj1 <- get_projection(projection = model_prj1, 
               ...
               distance_df_small_edges = tr_from_to_df_two_curvy, 
...
proj_obj1 <- get_projection(projection = projection, 
               ...
               distance_df_small_edges = tr_from_to_df_gau1, 
...
proj_obj1 <- get_projection(projection = projection,
                            ...
                            distance_df_small_edges = tr_from_to_df_dens_clust,
...
proj_obj1 <- get_projection(projection = projection, 
               ...
               distance_df_small_edges = tr_from_to_df_pbmc, 
               axis_param = list(limits = 1,
                                 axis_scaled = 1, 
                                 axis_pos_x = -0.48, 
                                 axis_pos_y = -0.48, 
...
df_b_mnist <- df_bin_mnist |>
  dplyr::filter(hb_id %in% hexID_mnist) |>
  dplyr::mutate(type = "model") ## Data with summarized mean

## Reorder the rows of df_b according to the hexID order in df_b_with_center_data
df_b_mnist <- df_b_mnist[match(hexID_mnist, df_b_mnist$hb_id),] |>
  dplyr::select(-hb_id) 
...
proj_obj1 <- get_projection(projection = projection, 
               ...
               distance_df_small_edges = tr_from_to_df_mnist, 
               axis_param = list(limits = 1, 
                                 axis_scaled = 1, 
                                 axis_pos_x = -0.92, 
                                 axis_pos_y = -0.92, 
