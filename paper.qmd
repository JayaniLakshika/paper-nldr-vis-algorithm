...
The paper is organized as follows. @sec-background provides a summary of the literature on NLDR and high-dimensional data visualization methods. @sec-method contains the details of the new methodology, including a simulated data example. In @sec-bestfit, we describe a workflow for assessing the quality of \gD{} layouts based on the proposed model diagnostics.  Two applications illustrating the use of the new methodology for bioinformatics and image classification are in @sec-applications. Limitations and future directions are provided in @sec-discussion. 
...
## Choosing a \gD{} layout {#sec-bestfit}
