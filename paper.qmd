...
These `R` packages were used for the work:. These `python` packages were used for the work:. The article was created with `R` packages `rticles`, `knitr`, and `rmarkdown`. The project's GitHub repository ([https://github.com/JayaniLakshika/paper-nldr-vis-algorithm](https://github.com/JayaniLakshika/paper-nldr-vis-algorithm)) contains all materials required to reproduce this article.
