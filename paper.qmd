...
num_bins_for_nldr_methods_df <- tibble::tibble(NLDR_technique = "tSNE", tot_bins = 8)

num_bins_for_nldr_methods_df <- num_bins_for_nldr_methods_df |> 
  tibble::add_row(NLDR_technique = "UMAP", tot_bins = 6)

num_bins_for_nldr_methods_df <- num_bins_for_nldr_methods_df |> 
  tibble::add_row(NLDR_technique = "PHATE", tot_bins = 8)

num_bins_for_nldr_methods_df <- num_bins_for_nldr_methods_df |> 
  tibble::add_row(NLDR_technique = "TriMAP", tot_bins = 6)

num_bins_for_nldr_methods_df <- num_bins_for_nldr_methods_df |> 
  tibble::add_row(NLDR_technique = "PaCMAP", tot_bins = 10)
...
colnames(num_bins_for_nldr_methods_df) <- c('NLDR technique', 'total number of bins')
num_bins_for_nldr_methods_df <- tibble::remove_rownames(num_bins_for_nldr_methods_df)

xtable(num_bins_for_nldr_methods_df, caption = "Total number of bins suggested by rule of thumb for each NLDR technique applied to S-curve dataset.", label = "tbl-msebinsnldr") |>
  xtable2kable() |> 
  kable_styling(latex_options = c("striped", "HOLD_position"), position = "center", full_width = FALSE) |>
  row_spec(0, bold = TRUE) 
...
- By comaring AIC what is the best NLDR technique to reprrsnt NLDR data
