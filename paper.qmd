...
Projections of the $7\text{-}D$ S-curve data (purple points) overlaid with the model (black grid with  green points indicating bin means) constructed from the UMAP layout, with 48 non-empty bins (using the **langevitour** software). The model closely fits the shape of this data. A video of the full tour is available at (<https://youtu.be/G1m4q9k--v4>).
:::
