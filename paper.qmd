...
rmse_two_curvy_relcount <- ggplot(error_two_curvy_tsne, 
                     aes(x = n_bar, 
                         y = HBE)) +
  geom_vline(xintercept = error_two_curvy_tsne$n_bar[15],
           colour = "#d95f02", linetype="dashed", 
           linewidth=1) +
  geom_vline(xintercept = error_two_curvy_tsne$n_bar[13],
             colour = "#1f78b4", 
             linetype="solid",
             linewidth=1) +
  geom_vline(xintercept = error_two_curvy_tsne$n_bar[11], linetype="dotted",
             colour = "#1b9e77", linewidth=1) +
  geom_line(linewidth = 0.5) + 
  geom_point(size = 1) +
