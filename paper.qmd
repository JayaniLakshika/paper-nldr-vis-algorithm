...
![](figures/scurve/sc_true_1.png)

![](figures/scurve/sc_true_2.png)

![](figures/scurve/sc_true_3.png)
...
![](figures/scurve/sc_true_only.png)

![](figures/scurve/pred_true_view.png)
...
@fig-scurve-sc-best shows one of the best fits for S-curve data. TriMAP with $15$ nearest neighbors for forming the nearest neighbor triplet (`n_inliers`), $3$ outliers for forming the nearest neighbor triplets (`n_outliers`), $3$ random triplets per point (`n_random`).
...
Model in \gD{}, on the TriMAP layout, and three views of the fit in projections from $7\text{-}D$, for the S-curve data. The model closely fits the shape, and it adequately captures the surface. (The **langevitour** software is used to view the data with a tour, and the full video is available at (<https://youtu.be/zEz2MUCtADM>). 
:::
