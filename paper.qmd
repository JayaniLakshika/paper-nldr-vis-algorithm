...
error_df <- error_df |>
  mutate(type = if_else(total == 0, "no error",
                        if_else(total <= 80, "error 1-50",
                                if_else(total <= 100, "error 50-100",
                                        if_else(total <= 200, "error 100-200",
                                                if_else(total <= 300, "error 200-300",
                                                        if_else(total <= 400, "error 300-400",
                                                                if_else(total <= 500, "error 400-500", "error greter than 500"))))))))

plot_list2_mnist_error <- error_df |>
  mutate(type = factor(type , levels = c("no error", "error 1-50", "error 50-100", "error 100-200", "error 200-300", "error 300-400", "error 400-500", "error greter than 500"))) |>
    ggplot(aes(x = PaCMAP1,
