...
trimesh_removed_pbmc <- ggplot() + 
  ...
  interior_annotation("a1", cex = 1.5) +
  theme(
    aspect.ratio = 1
  )
...
pbmc_proj_umap_model1 <- projected_df |>
  ...
  xlim(c(-0.65, 0.65)) +
  ylim(c(-0.65, 0.65)) +
  interior_annotation("a2", cex = 1.5)
...
pbmc_proj_umap_model2 <- projected_df |>
  ...
  xlim(c(-1, 0.75)) +
  ylim(c(-1, 0.75)) +
  interior_annotation("a3", cex = 1.5)
...
trimesh_removed_pbmc_best <- ggplot() + 
  ...
  interior_annotation("b1", cex = 1.5) +
  theme(
    aspect.ratio = 1
  )
...
pbmc_proj_umap_model1_best <- projected_df |>
  ...
  xlim(c(-0.65, 0.65)) +
  ylim(c(-0.65, 0.65)) +
  interior_annotation("b2", cex = 1.5)
...
pbmc_proj_umap_model2_best <- projected_df |>
  ...
  xlim(c(-1, 0.75)) +
  ylim(c(-1, 0.75)) +
  interior_annotation("b3", cex = 1.5)
...
trimesh_removed_mnist <- ggplot() + 
  ...
  interior_annotation("a", sc_ltr_pos_mnist, cex = 1.5) +
  theme(legend.position = "none") 
