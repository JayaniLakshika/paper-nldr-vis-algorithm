...
mse_two_curvy_b <- ggplot(error_two_curvy_clust_umap, 
  ...
  geom_vline(xintercept = 0.04,
             color = "#006d2c", linetype=2,
             linewidth=1) +
  geom_vline(xintercept = 0.12, linetype=2,
             color = "#08519c", linewidth=1) +
  geom_line(linewidth = 0.5) + 
  geom_point(size = 1) +
  # scale_x_continuous(breaks = sort(unique(round(error_two_curvy_clust_umap$a1, 2)))[c(1, 3, 5, 6, 8, 10:12)]) +
...
mse_two_curvy_lwd <- ggplot(error_rm_two_curvy, 
  ...
  #        transform = "reverse") + 
  scale_x_continuous(breaks = unique(error_rm_two_curvy$benchmark_rm_lwd)) +
