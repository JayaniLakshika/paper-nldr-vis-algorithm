...
error_df_one_curvy_abs_selected1 <- error_df_one_curvy_abs |>
  dplyr::filter(error_cat_n == "selected")

error_df_one_curvy_abs_deselected1 <- error_df_one_curvy_abs |>
  dplyr::filter(error_cat_n == "deselected")

error_plot_one_curvy_hist_selected <- ggplot(error_df_one_curvy_abs_deselected1, 
      aes(x = sqrt_row_wise_total_error, 
          y = density)) +
  geom_point(alpha=0.7, color = "#d9d9d9") +
  geom_point(data = error_df_one_curvy_abs_selected1, 
      aes(x = sqrt_row_wise_total_error, 
          y = density),
...
error_plot_one_curvy_hist <- ggplot(error_df_one_curvy_abs_deselected1, 
      aes(x = sqrt_row_wise_total_error, 
          y = density)) +
  geom_point(alpha=0.7, color = "#d9d9d9") +
  geom_point(data = error_df_one_curvy_abs_selected1, 
