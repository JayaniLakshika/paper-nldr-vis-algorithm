...
These `R` packages were used for the work: `tidyverse` (@hadley2019), `png` (@simon2022), `Rtsne` (@jesse2015), `umap` (@tomasz2023), `ggplot2` (@hadley2016), `patchwork` (@thomas2024), `colorspace` (@achim2020), `langevitour` (@harisson2024), `conflicted` (@hadley2023), `reticulate` (@kevin2024), `kableExtra` (@hao2024). These `python` packages were used for the work: `trimap` and `pacmap`. The article was created with `R` packages `rticles` (@jjallaire2024), `knitr` (@yihui2014), and `rmarkdown` (@yihui2020). The project's GitHub repository ([https://github.com/JayaniLakshika/paper-nldr-vis-algorithm](https://github.com/JayaniLakshika/paper-nldr-vis-algorithm)) contains all materials required to reproduce this article.
