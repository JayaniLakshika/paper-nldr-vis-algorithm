...
```{r}
#| label: fig-rm-lg
#| fig-cap: "\\gD{} Vs $7\\text{-}D$ distance between the bin centroids and wireframes in \\gD{} and $7\\text{-}D$ with Delaunay triangulation, and two choices of long edge removal: (b) benchmark = 6.5$a_1$ and (c) benchmark = 2$a_1$, where $a_1$ = 0.03."
#| fig-height: 15
#| fig-width: 15
