...
To illustrate how the methods organise difference number of points within the structure in the NLDR layout, simulated $7\text{-}D$ data having C-shaped structure is used. 
