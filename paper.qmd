...
distance_two_curvy_dist <- distance_two_curvy |> 
  ...
  dplyr::filter(distance > 0.1) ## To remove a1 distances, since always small
...
```{r}
#| fig-cap: "Wireframes with Delaunay triangulation, and two choices of edge removal in \\gD{} and \\pD{}. "

free(distance_hist) + wrap_plots(trimesh_two_curvy2, trimesh_two_curvy_removed2, trimesh_two_curvy_removed1, ncol = 2) 
```
