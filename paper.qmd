...
two_curvy_proj_tsne_first_model1 <- plot_proj(
    ...
    axis_text_size = 2, 
    is_category = FALSE) +
  interior_annotation(label = "b", position = sc_ltr_pos, cex = 1) +
  theme(aspect.ratio = 1,
        legend.position = "none") 
...
two_curvy_proj_tsne_all_model1 <- plot_proj(
  ...
  axis_text_size = 2, 
  is_category = FALSE) +
  interior_annotation(label = "c", position = sc_ltr_pos, cex = 1) +
  theme(aspect.ratio = 1) #+
  #geom_segment(
  #  data = model_df, 
  #  aes(
...
counts_df_two_curvy2 <- algo_obj_two_curvy3$hb_obj$std_cts
...
five_gau_proj_tsne_model2 <- plot_proj(
  ...
  axis_text_size = 4, 
  is_category = FALSE) +
  interior_annotation(label = "a3", position = c(0.08, 0.9), cex = 1.5) +
  theme(aspect.ratio = 1,
        legend.position = "none") 
```
...
five_gau_proj_umap_model2 <- plot_proj(
  ...
  axis_text_size = 4, 
  is_category = FALSE) +
  interior_annotation(label = "b3", position = c(0.08, 0.9), cex = 1.5) +
  theme(aspect.ratio = 1,
        legend.position = "none")
```
...
five_gau_proj_pacmap_model2 <- plot_proj(
  ...
  axis_text_size = 4, 
  is_category = FALSE) +
  interior_annotation(label = "c3", position = c(0.08, 0.9), cex = 1.5) +
  theme(aspect.ratio = 1,
        legend.position = "none")
