...
umap_scurve_scaled <- gen_scaled_data(data = umap_scurve, x = "UMAP1", 
                                      y = "UMAP2", hr = 2/sqrt(3))
...
hb_obj_scurve <- hex_binning(data = umap_scurve_scaled, x = "UMAP1",
                      ...
                      num_bins_y = num_bins_y_scurve, x_start = x_start_scurve,
                      y_start = y_start_scurve, buffer_x = buffer_x_scurve,
                      buffer_y = buffer_y_scurve, hex_size = hex_size_scurve,
                      col_start = "UMAP")
