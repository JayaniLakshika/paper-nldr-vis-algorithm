...
tsne_two_curvy_plt <- tsne_two_curvy_scaled |>
  ggplot(aes(x = tSNE1,
             y = tSNE2))+
  geom_point(alpha=0.1, size=1, colour='#a65628') +
...
a1_2_tsne <- hb_obj_tsne_two_curvy2$a1
...
df_bin_centroids4 <- extract_hexbin_centroids(
  centroids_data = all_centroids_df4, 
  counts_data = counts_df4) |>
  mutate(b1 = "b1 = 11")
...
df_bin_two_curvy4 <- avg_highd_data(highd_data = training_data_two_curvy,
                                    scaled_nldr_hexid = tsne_data_two_curvy2_with_hb_id)
...
nldr_two_curvy_original2 + tsne_two_curvy_plt +
  pacmap_two_curvy_plt +
