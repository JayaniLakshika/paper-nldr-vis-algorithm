...
highd_error_2d_mnist <- error_df |>
  ...
  geom_rect(aes(xmin = 0.4, xmax = 0.5, ymin = 0.75, ymax = 0.9),
               fill = "transparent", color = "#377eb8", linewidth = 0.7)  +
  geom_rect(aes(xmin = 0.45, xmax = 0.55, ymin = 0.75, ymax = 0.9),
               fill = "transparent", color = "#4daf4a", linewidth = 0.7)  +
  geom_rect(aes(xmin = 0.55, xmax = 0.65, ymin = 0.75, ymax = 0.9),
               fill = "transparent", color = "#a65628", linewidth = 0.7) 
  # scale_colour_brewer(
  #   type = "seq",
  #   palette = 1
  # ) #+ 
