...
#| fig-height: 10
#| fig-width: 10
#| fig-cap: "Model in \\gD{}, on the UMAP layout, and three views of the fit in projections from $9\\text{-}D$, for the PBMC3k data ($b = 870 \  (30, \ 29)$, $m = 135$, benchmark value to remove large edges is $0.099$) The full video is available at <https://youtu.be/VqqWuE0Jj6A>."
