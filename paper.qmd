...
#| fig-cap: "Examining the distribution of residuals in a jittered dotplot (a), \\gD{} NLDR layout (b) and a tour of \\fD{} data space (c). Color indicates error ($e_{hj}$), dark color indicating high error and light indicates low error. Most large errors are distributed in one cluster (bottom one in c) and most small errors are distributed in the other cluster."
#| out-width: 100%
#| fig-pos: H
#| fig-width: 8
#| fig-height: 3
