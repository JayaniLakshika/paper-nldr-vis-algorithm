...
for (xbins in bin1_vec_pbmc) {
  ...
  bin2 <- calc_bins_y(bin1 = xbins, r2 = r2, q = 0.1)$bin2
...
error_plot_pbmc <- ggplot(error_pbmc, 
  ...
  geom_vline(xintercept = 124, linetype="solid", 
             color = "black", linewidth=0.8, alpha = 0.5) +
