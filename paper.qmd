...
true_model_df <- read_rds("data/two_non_linear_diff_shaped_close_clusters/two_non_linear_diff_shaped_close_clusters_true_model_std.rds")
...
# Apply the scaling
df_model_data_two_curvy <- bind_rows(
  data_two_curvy, 
  true_model_two_curvy, 
  df_b_two_curvy2)
