...
algo_obj_gau1 <- gen_nldr_vis_algo_obj(
  high_d_data = training_data_gau, 
  nldr_data = tsne_data_gau, 
  num_x_bins = num_bins_x_gau1)

tsne_gau_scaled <- algo_obj_gau1$nldr_scaled
tr_from_to_df_gau1 <- algo_obj_gau1$tr_from_to_df
df_bin_centroids_gau1 <- algo_obj_gau1$df_bin_centroids
df_bin_gau1 <- algo_obj_gau1$df_bin
...
projection <- cbind(
  c(0.07108,0.19751,-0.21229,0.26341),
  c(-0.23494,0.27965,-0.01430,-0.15782))
...
umap_gau_scaled <- algo_obj_gau1$nldr_scaled
tr_from_to_df_gau1 <- algo_obj_gau1$tr_from_to_df
df_bin_centroids_gau1 <- algo_obj_gau1$df_bin_centroids
df_bin_gau1 <- algo_obj_gau1$df_bin
...
pacmap_gau_scaled <- algo_obj_gau1$nldr_scaled
tr_from_to_df_gau1 <- algo_obj_gau1$tr_from_to_df
df_bin_centroids_gau1 <- algo_obj_gau1$df_bin_centroids
df_bin_gau1 <- algo_obj_gau1$df_bin
