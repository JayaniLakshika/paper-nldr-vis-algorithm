...
two_curvy_proj_tsne_model1 <- projected_df |>
  ggplot(
    aes(
      x = proj1, 
      y = proj2)) +
...
two_curvy_proj_tsne_model2 <- projected_df |>
  ggplot(
    aes(
      x = proj1, 
      y = proj2)) +
...
plot_predict_umap_two_curvy <- ggplot(
  ...
  interior_annotation("c", c(0.92, 0.96), cex = 2)
```
...
plot_predict_umap_fun_two_curvy <- ggplot(
  ...
  aes(x = UMAP1, 
      y = UMAP2)) +
  geom_point(alpha = 0.5) +
  interior_annotation("b", c(0.92, 0.96), cex = 2)
```
...
plot_predict_umap_connect_two_curvy <- ggplot(
  ...
  geom_point(alpha = 0.5) +
  geom_line(alpha = 0.3) +
  interior_annotation("d", c(0.92, 0.96), cex = 2)
```
