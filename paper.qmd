...
tSNE_data <- Fit_tSNE(training_data, opt_perplexity = calculate_effective_perplexity(training_data), with_seed = 20240110)
...
#| message: false
#| warning: false
hex_full_count_df_loop3 <- read_rds("data/s_curve/s_curve_hex_15.rds") 
