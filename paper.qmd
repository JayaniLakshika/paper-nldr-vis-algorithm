...
```{r}
#| fig-cap: "Assessing which of the 5 NLDR layouts on the MNIST digit 1 data is the better representation using MSE for varying binwidth ($a_1$). Colour used for the lines and points in the left plot and in the scatterplots represents NLDR layout (a-e). All the layouts appear to be very similar. Layout c is universally poor. Layouts f that show two close clusters are universally suboptimal. Layout f is the best choice."
#| label: fig-mnist-mse
#| fig-pos: H
#| out-width: 80%
