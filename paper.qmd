...
projection <- cbind(
    c(-0.2782,0.2156,0.1410,0.8068,0.0804,-0.0315,0.4449),
    c(-0.6090,0.3014,-0.1654,-0.3381,-0.0964,0.5900,0.1979))
...
projection <- cbind(
    c(-0.6296,-0.1452,0.3314,0.2259,-0.4488,-0.0053,-0.4693),
    c(0.5314,0.4634,0.1431,0.2129,-0.0107,0.1477,-0.6443))
...
mse_scurve_b <- ggplot(error_scurve, 
  ...
  geom_point(size = 1) +
  geom_line(linewidth = 0.05) + 
  geom_vline(xintercept = 0.096, linetype=2,
             color = "#bdbdbd", linewidth=1) +
  geom_vline(xintercept = 0.116,
             linetype="solid",
             color = "#bdbdbd",
             linewidth=1) +
  geom_vline(xintercept = 0.184, linetype=2,
             color = "#bdbdbd", linewidth=1) +
  scale_x_continuous(breaks = sort(unique(round(error_scurve$a1, 3)))) +
...
a1_m_scurve <- ggplot(error_scurve,
  ...
  #            color = "#bdbdbd", linewidth=1) +
  scale_y_continuous(breaks = sort(unique(error_scurve$b_non_empty))) +
  scale_x_continuous(breaks = sort(unique(round(error_scurve$a1, 3)))) +
