...
```{r}
#| echo: false
#| fig-cap: "(a) Visualization of bin centroids and (b) hexagonal grid, showcasing the configuration when the starting point defined at $(-0.113, -0.098)$ (colored in gray) and the starting point defined at $(-0.025, -0.108)$ (colored in light orange)."
