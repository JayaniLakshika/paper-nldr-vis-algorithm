...
error_plot_mnist <- ggplot(error_mnist, 
  ...
  scale_color_manual(values=c('#e41a1c','#377eb8','#999999', "#ff7f00",'#a65628')) +
  scale_y_log10() +
  ylab("MSE") +
  xlab(expression(paste("binwidth (", a[1], ")"))) +
  theme_minimal() +
