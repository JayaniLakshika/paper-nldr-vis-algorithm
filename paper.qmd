...
pacmap_minst_scaled <- gen_scaled_data(data = pacmap_minst)$scaled_nldr
...
#| eval: false
##| echo: false
#| fig-cap: "(a) Images of handwritten digit 1 which occur large model error within the nonlinear strcuture, and (b) Images of handwritten digit 1 which occur large model error outside the nonlinear structure."
#| label: fig-anomalies
#| out-width: 100%
#| fig-pos: H
