...
Another usability of our approach is how NLDR methods behave with different density of the data structure. The tSNE layout of simulated $4\text{-}D$ C-shaped data with different densities are used. The high \pD{} model errors are scattered to a corner of the \gD{} layout of dense C-shaped structure. In the dense C-shaped structure, the high model errors occur because there are fewer data points positioned within the bins at the sparse end of the structure.  
