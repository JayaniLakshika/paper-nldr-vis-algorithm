...
#| fig-pos: H
#| out-height: 50%
#| fig-cap: "The sparse end of the structure shows a high model error, while the dense end shows a low model error. The tSNE layout of the C-shaped structure, with dense points (a) are colored according to their high-dimensional error. Darker colors represent a high error, while lighter colors indicate a low error. b and c present the results from linked plots that brushed the high-dimensional error points in \\gD{} and $4\\text{-}D$. Videos of the linked plots are available at <>."
