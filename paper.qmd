...
#| fig-cap: "The $4\\text{-}D$ model error in \\gD{} layout. Color indicates error ($e_{hj}$), dark color indicating high error and light indicates low error. Most large errors are distributed near the sparse end of the non-linear cluster with dense corner."
#| out-width: 80%
#| fig-pos: H
