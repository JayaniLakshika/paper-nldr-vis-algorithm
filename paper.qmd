...
mse_scurve_b <- ggplot(error_scurve, 
  ...
  geom_vline(xintercept = diaconis_bin_width, 
             linetype=2, color = "#bdbdbd", 
             linewidth=1) +
...
# b1_m_scurve <- ggplot(error_scurve, 
#                      aes(x = bin1, 
#                          y = b_non_empty/b)) + 
#   geom_point(size = 1) +
#   geom_line(linewidth = 0.05) + 
...
#   #            color = "#bdbdbd", linewidth=1) +
#   scale_x_continuous(breaks = 5:19) +
#   labs(x = expression(b[1]), y = expression(frac(m, b))) +
#   ggtitle("(a)") +
#   theme(aspect.ratio = 0.75,
#         axis.text.x = element_text(size = 12),
#         axis.text.y = element_text(size = 12),
...
mse_scurve_b + mse_scurve_lwd + 
  mse_scurve_lwd2 + distance_hist + 
  plot_layout(ncol=2)
```
