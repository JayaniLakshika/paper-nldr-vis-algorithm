...
```{r}
#| echo: false
#| fig-cap: "(a) 2D layout from UMAP (n_components=2, n_neighbors=10, init=random, MN_ratio=0.9, FP_ratio=2.0) applied for the digit 1 of the MNIST dataset. Is this a best representation of the original data?, (b)  Model in the 2D space with PaCMAP ()"
