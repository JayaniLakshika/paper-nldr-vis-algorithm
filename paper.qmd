...
```{r}
#| echo: false
#| fig-cap: "(a) 2D layout from UMAP (n_neighbors = 100, min_dist = 0.3) applied for the PBMC3k dataset. Is this a best representation of the original data?, (b)  Model in the 2D space with UMAP (<https://youtu.be/1jNVVlzI4tM>)"
...
```{r}
#| echo: false
#| fig-cap: "(a) 2D layout from UMAP (n_neighbors = 15, min_dist = 0.3) applied for the PBMC3k dataset. Is this a best representation of the original data?, (b)  Model in the 2D space with UMAP (<https://youtu.be/2GM_SuM866M>)"
