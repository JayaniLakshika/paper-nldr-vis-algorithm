...
write_rds(tSNE_data_harps, "data/harps/harps_tsne_70.rds")

tSNE_data_harps <- read_rds("data/harps/harps_tsne_70.rds")
...
#benchmark_tsne_harps <- 1.1593422
...
error_sum_df <- tibble::tibble(perplexity = 70, total_error = sum(error_df$total))
