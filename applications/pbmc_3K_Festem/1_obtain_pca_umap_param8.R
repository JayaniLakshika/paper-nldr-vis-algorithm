...
UMAP_fit <- umap(training_data_pbmc |> dplyr::select(-ID), n_neighbors = 500, n_components =  2, metric = "cosine", min_dist = 0.3)
...
## Run only once
write_rds(UMAP_pbmc, file = "data/pbmc/pbmc_umap_5_min_dist_0.3.rds")
...
UMAP_pbmc <- read_rds("data/pbmc/pbmc_umap_5_min_dist_0.3.rds")
