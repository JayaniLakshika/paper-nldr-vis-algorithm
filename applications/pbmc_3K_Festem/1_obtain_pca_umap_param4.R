...
UMAP_fit <- umap(training_data_pbmc |> dplyr::select(-ID), n_neighbors = 15, n_components =  2, metric = "cosine", min_dist = 0.3)
...
## Run only once
write_rds(UMAP_pbmc, file = "data/pbmc/pbmc_3k_festem/pbmc_umap_15_min_dist_0.3.rds")
...
UMAP_pbmc <- read_rds("data/pbmc/pbmc_3k_festem/pbmc_umap_15_min_dist_0.3.rds")
