...
UMAP_fit <- umap(training_data_pbmc |> dplyr::select(-ID), n_neighbors = 30, n_components =  2, metric = "cosine", min_dist = 0.01)
...
## Run only once
write_rds(UMAP_pbmc, file = "data/pbmc/pbmc_3k_festem/pbmc_umap_30_min_dist_0.01.rds")
...
UMAP_pbmc <- read_rds("data/pbmc/pbmc_3k_festem/pbmc_umap_30_min_dist_0.01.rds")
