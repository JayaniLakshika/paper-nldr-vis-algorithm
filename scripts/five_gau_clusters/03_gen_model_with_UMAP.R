...
write_rds(umap_gau_scaled, "data/five_gau_clusters/umap_gau_scaled.rds")
...
write_rds(proj_obj1, "data/five_gau_clusters/umap_gau_proj_obj1.rds")
...
write_rds(proj_obj2, "data/five_gau_clusters/umap_gau_proj_obj2.rds")
