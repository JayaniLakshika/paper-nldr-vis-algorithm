## This script is to generate the model with tSNE for Five Gaussian clusters data
library(quollr)
library(tidyverse)
...
tsne_gau_scaled <- algo_obj_gau1$nldr_scaled_obj$scaled_nldr
...
write_rds(tsne_gau_scaled, "data/five_gau_clusters/tsne_gau_scaled.rds")
write_rds(tr_from_to_df_gau1, "data/five_gau_clusters/tr_from_to_df_gau1.rds")
...
write_rds(proj_obj1, "data/five_gau_clusters/tsne_gau_proj_obj1.rds")
...
write_rds(proj_obj2, "data/five_gau_clusters/tsne_gau_proj_obj2.rds")
