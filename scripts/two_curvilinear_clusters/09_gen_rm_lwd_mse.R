...
training_data_two_curvy <- read_rds("data/two_curvy_clust/two_curvy_clust_data.rds")
training_data_two_curvy <- training_data_two_curvy |>
  mutate(ID = row_number())

umap_two_curvy <- read_rds(file = "data/two_curvy_clust/two_curvy_clust_umap_n-neigbors_15_min-dist_0.1.rds")
...
write_rds(error_rm_two_curvy, here::here("data/two_curvy_clust/error_rm_lwd_diff_bin.rds"))
