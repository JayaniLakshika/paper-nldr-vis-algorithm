...
error_mnist_trimap <- read_rds("data/two_nonlinear_clusters/error_two_nonlinear_clusters_trimap.rds")
error_mnist_pacmap <- read_rds("data/two_nonlinear_clusters/error_two_nonlinear_clusters_pacmap.rds")
