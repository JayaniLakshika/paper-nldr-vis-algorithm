...
## Import data
df_s_curve <- read_csv("data/s_curve/s_curve.rds")

training_data_s_curve <- read_rds("data/s_curve/s_curve_training.rds")

UMAP_s_curve <- read_rds("data/s_curve/s_curve_umap.rds") ## n_neighbor:50
...
write_rds(hex_full_count_df, "data/s_curve/s_curve_umap_50_hex_6.rds")
