...
highd_data <- read_rds("data/mnist/mnist_10_pcs_of_digit_1.rds")
names(highd_data) <- paste0("x", 1:NCOL(highd_data))

embeddings <- list(
  tSNE  = read_rds(here("data/mnist/mnist_tsne30.rds")),
  tSNE2  = read_rds(here("data/mnist/mnist_tsne89.rds")),
  UMAP      = read_rds(here("data/mnist/mnist_umap.rds")),
  PHATE     = read_rds(here("data/mnist/mnist_phate.rds")),
  TriMAP    = read_rds(here("data/mnist/mnist_trimap.rds")),
  PaCMAP    = read_rds(here("data/mnist/mnist_pacmap.rds"))
)
...
write_rds(results_all, "data/mnist/nldr_eval_metrics.rds")
...
write_rds(RNX_curves, "data/mnist/RNX_curves.rds")
...
write_rds(shepard_all, "data/mnist/shepard_all.rds")
