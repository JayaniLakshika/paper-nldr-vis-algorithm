...
trimesh_gr_s_curve_tsne <- colour_long_edges(.data = distance_s_curve, benchmark_value = benchmark,
                                             triangular_object = tr1_object_s_curve, distance_col = distance)

tour1_s_curve_tsne <- show_langevitour(df_all_s_curve, df_bin_s_curve,
