...
for(i in 1:length(benchmark_dist_vec)) {
  ...
  pred_df_training_object <- predict_hex_id(training_data = training_data_s_curve, nldr_df = PaCMAP_s_curve, nldr_df_test = PaCMAP_s_curve, num_bins = num_bins_s_curve, shape_val = shape_value_s_curve, x = "PaCMAP1", y = "PaCMAP2", col_start = "x")
