...
model_data <- bind_rows(curvy1, curvy2)
...
write_rds(model_data, "data/two_c_shaped_clust/two_c_shaped_clust_true_model.rds")
write_rds(connections_all, "data/two_c_shaped_clust/two_c_shaped_clust_true_model_connections.rds")
