...
plot_tsne_dens_selected <- error_df_one_curvy_abs |>
  ggplot(aes(x = tSNE1,
             y = tSNE2,
...
projected_df <- projected_df |>
  ...
  mutate(error_cat_n2 = error_df_one_curvy_abs$error_cat_n2)
...
five_c_shaped_proj_tsne_model1_selected <- projected_df |>
  ggplot(
    aes(
      x = proj1,
      y = proj2)) +
