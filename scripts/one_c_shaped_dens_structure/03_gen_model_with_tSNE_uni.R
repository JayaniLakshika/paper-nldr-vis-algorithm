...
## Import data
training_data_one_nonlinear_structure <- read_rds("data/one_c_shaped_dens_structure/one_c_shaped_uni_dens_data.rds")
...
tSNE_one_nonlinear_structure <- read_rds("data/one_c_shaped_dens_structure/one_c_shaped_uni_dens_structure_tsne_perplexity_52.rds")
...
num_bins_x_one_nonlinear_structure <- 15
