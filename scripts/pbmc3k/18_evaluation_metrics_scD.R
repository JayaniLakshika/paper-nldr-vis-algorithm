...
write_rds(results_all, "data/pbmc3k/nldr_eval_metrics_scdeed.rds")
...
RNX_curves <- purrr::imap_dfr(embeddings, function(lowd, name) {
  ...
  mutate(method = factor(method, levels = c("UMAP_30_min_dist_0.3", "tsne_perplexity_30")))

write_rds(RNX_curves, "data/pbmc3k/RNX_curves_scdeed.rds")
...
write_rds(shepard_all, "data/pbmc3k/shepard_all_scdeed.rds")
