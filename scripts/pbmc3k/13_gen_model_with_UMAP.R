## This script is to generate the model with UMAP for PBMC3k data
library(quollr)
library(tidyverse)
...
umap_pbmc_scaled <- algo_obj_pbmc$nldr_scaled_obj$scaled_nldr
...
write_rds(proj_obj1, "data/pbmc3k/pbmc_umap_proj_obj1.rds")
...
write_rds(proj_obj2, "data/pbmc3k/pbmc_umap_proj_obj2.rds")
